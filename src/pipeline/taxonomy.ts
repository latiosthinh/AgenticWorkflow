...
export const GOLDEN_PATH_V2: readonly StepDefinition[] = Object.freeze([
  Object.freeze({
    ...
    evidenceLevels: Object.freeze(['L1']),
    primaryEvidenceLevel: 'L1',
    adoState: 'New',
    gateType: 'automated_trigger',
    keyTags: Object.freeze(['[audit-passed]', '[awaiting-scope-lock]']),
  ...
  Object.freeze({
    ...
    keyTags: Object.freeze(['[awaiting-scope-lock]', '[scope-locked]']),
  ...
  Object.freeze({
    ...
    actor: 'AI',
    actorDetail: 'AI Agent',
    evidenceLevels: Object.freeze(['L2', 'L3']),
    primaryEvidenceLevel: 'L3',
    adoState: 'In Dev',
    gateType: 'automated_trigger',
    keyTags: Object.freeze(['[awaiting-input]']),
  ...
  Object.freeze({
    ...
    adoState: 'Dev Done',
    gateType: 'human_verdict',
    keyTags: Object.freeze(['[awaiting-acceptance]', '[acceptance-approved]']),
  ...
  Object.freeze({
    ...
    evidenceLevels: Object.freeze(['L3', 'L4']),
    primaryEvidenceLevel: 'L4',
    adoState: 'Dev Done',
    gateType: 'human_verdict',
    keyTags: Object.freeze(['[pr-merged]']),
  ...
  Object.freeze({
    ...
    evidenceLevels: Object.freeze(['L3', 'L5']),
    primaryEvidenceLevel: 'L5',
    adoState: 'Ready for QA',
    gateType: 'human_verdict',
    keyTags: Object.freeze(['[qa-verified]', '[qa-failed]']),
  ...
  Object.freeze({
    ...
    evidenceLevels: Object.freeze(['L5']),
    primaryEvidenceLevel: 'L5',
    adoState: 'Ready to Deploy',
    gateType: 'human_verdict',
    keyTags: Object.freeze(['[deploying]']),
  ...
  Object.freeze({
    ...
    evidenceLevels: Object.freeze(['L6']),
    primaryEvidenceLevel: 'L6',
    adoState: 'Ready to Deploy',
    gateType: 'automated_trigger',
    keyTags: Object.freeze(['[deploy-regressed]', '[smoke-harness-error]']),
  ...
  Object.freeze({
    ...
    evidenceLevels: Object.freeze(['L7']),
    primaryEvidenceLevel: 'L7',
    adoState: 'Done',
    gateType: 'automated_trigger',
    keyTags: Object.freeze(['[golden-path-complete]', '[retro-failed]']),
