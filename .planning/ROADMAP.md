...
- [x] 03-02-PLAN.md — Scope Verdict Detection, Approval/Rejection Gate, and Refinement Breaker Isolation
- [x] 03-03-PLAN.md — Scope Watchdog, Router Step 3 Guard, Lifecycle Replay, and Service Wiring
...
- [x] 05-03-PLAN.md — Deployment worker fail-fast sequencing, tag patching, and composite L6 evidence index
